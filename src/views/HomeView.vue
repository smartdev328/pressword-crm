                      ...
                      <div class="flex-grow-1 ms-3">
                        <h2 class="mb-0">
                          ₦ <span class="counter-value"
                                  data-target="540.30">540.30</span>
                        </h2>
                      </div>
                    </div>
                  </div>
                ...
                <table class="table align-middle mb-0">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="#">
                        <i
                          class="ri-edit-line fs-17 align-middle"></i>
                      </a>
                      <a href="#">
                        <i class="ri-delete-bin-line fs-17 align-middle text-danger"></i>
                      </a>
                    </td>
                  </tr>
                  <tr>
                ...
                <li class="list-group-item ps-0">
                  <div class="row align-items-center g-3">
                    ...
                    <div class="col">
                      ...
                      <a href="#" class="text-reset fs-14 mb-0">Meeting
                        for campaign with sales team</a>
                    </div>
            ...
            <div class="card-body p-4">
              ...
              <form action="javascript:void(0);">
                <div class="row">
                  <div class="col-6">
                    <div class="mb-3">
                      <label htmlFor="firstNameinput" class="form-label">First
                        Name</label>
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      <label htmlFor="lastNameinput" class="form-label">Last
                        Name</label>
                      <input type="text" class="form-control"
                  ...
                  <div class="col-12">
                    <div class="mb-3">
                      <label htmlFor="compnayNameinput" class="form-label">Company
                        Name</label>
                      <input type="text" class="form-control"
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      <label htmlFor="phonenumberInput" class="form-label">Phone
                        Number</label>
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      <label htmlFor="emailidInput" class="form-label">Email
                        Address</label>
