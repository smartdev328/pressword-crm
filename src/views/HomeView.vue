                  ...
                  <div class="py-4 px-3">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <h2 class="mb-0">
                          ₦
                          <span class="counter-value" data-target="540.30"
                            >540.30</span
                          >
                        </h2>
                      </div>
                ...
                <div class="col">
                  <div class="mt-3 mt-md-0 py-4 px-3">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <i
                          class="ri-contacts-book-line display-6 text-muted"
                        ></i>
                      </div>
                      <div class="flex-grow-1 ms-3">
                        <h2 class="mb-0">
                          <span class="counter-value" data-target="132">
                            132
                          </span>
                        </h2>
                      </div>
            ...
            <div class="card-body p-4">
              <form action="javascript:void(0);">
                <div class="row">
                  <div class="col-6">
                    <div class="mb-3">
                      <label htmlFor="firstNameinput" class="form-label"
                        >First Name</label
                      >
                      <input
                        type="text"
                  ...
                  <div class="col-12">
                    <div class="mb-3">
                      <label htmlFor="compnayNameinput" class="form-label"
                        >Company Name</label
                      >
                      <input
                        type="text"
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      <label htmlFor="phonenumberInput" class="form-label"
                        >Phone Number</label
                      >
                      <input
                        type="tel"
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      <label htmlFor="emailidInput" class="form-label"
                        >Email Address</label
                      >
                      <input
                        type="email"
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      <label htmlFor="citynameInput" class="form-label"
                        >City</label
                      >
                      <input
                        type="email"
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      <label htmlFor="ForminputState" class="form-label"
                        >State</label
                      >
